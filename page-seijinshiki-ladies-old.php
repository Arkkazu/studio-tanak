  ...
  <div class="max-pc:pb-48">
    ...
    <main class="py-70 pc:py-160 ">
      ...
      <div class="relative w-full">
        <picture>
          <source media='(min-width: 768px)' srcset='/wp-content/themes/studio-tanak_theme/src/images/legacy-old/seijinshiki-ladies/seijinWimg_pc.webp'>
          <img class='w-full' src='/wp-content/themes/studio-tanak_theme/src/images/legacy-old/seijinshiki-ladies/seijinWimg_sp.webp' alt='成人式女性' loading='lazy' width='1125' height='1130'>
        </picture>
        <div class="absolute left-0 md:left-160 pc:left-450 top-1/2 -translate-y-1/2">
          <h1 class="text-20 pc:text-30 font-zen-maru-gothic opacity-0 md:opacity-100">成人式女性</h1>
        </div>
      </div>
      ...
      <section class="mt-32 pc:mt-88">
        <div class="mx-auto w-343 md:w-736 pc:w-1450">
          ...
          <div class="flex items-center flex-col gap-y-4 pc:gap-y-8">
            <h2 class="text-14 pc:text-30 font-zen-maru-gothic half-leading">成人式女性 前撮りメニュー</h2>
          </div>
          ...
          <div class="mt-32 pc:mt-104">
            ...
            <div class="mt-14 pc:mt-28">
                  ...
                  <div class="flex justify-center items-center flex-wrap pc:flex-nowrap gap-y-12">
                    <div>
                      <div class="flex items-center gap-x-12 pc:gap-x-24">
                        ...
                        <span class="text-17 pc:text-33 leading-none half-leading">¥31,900</span>
                      </div>
                    </div>
                    ...
                    <div class="ml-0 md:ml-80">
                      <p class="text-10 pc:text-25">所要時間：2時間</p>
                    </div>
                  </div>
                  <div class="flex justify-center">
                    <div class="md:w-568">
                      <img src="/wp-content/themes/studio-tanak_theme/src/images/legacy-old/seijinshiki-ladies/20W_TOJITU.webp" alt="" class="w-full" width="888" height="257">
                    </div>
                  </div>
                  <div class="w-full h-px bg-black"></div>
                  <div class="w-full pc:w-auto">
                    <div class="flex justify-center flex-wrap pc:flex-nowrap gap-x-20 pc:gap-x-80 gap-y-24">
                      ...
                      <div class="flex items-center flex-col gap-8">
                        <div class="h-62 pc:h-90 flex justify-center items-center">
                          <div class="w-48 pc:w-65">
                            <img src="/wp-content/themes/studio-tanak_theme/src/images/legacy-old/common/daishi_out.svg" alt="" class="w-full" width="65" height="78">
                          </div>
                        </div>
                        <div class="flex justify-center items-center">
                          <span class="text-8 pc:text-16 text-center leading-[1.3] text-light-gray">
                      ...
                      <div class="border border-border flex flex-col">
                        ...
                        <div class="bg-white py-12 pc:py-24 px-16 md:px-40 pc:px-160 flex pc:justify-center">
                          <p class="text-10 pc:text-20 leading-[1.5]">
                            振袖・袋帯・帯揚げ・帯締め・長襦袢・草履＆バッグ<br>
                            紐類（腰紐・伊達締め・コーリンベルト・三重仮紐）<br>
                            帯枕・衿芯
                          </p>
                        </div>
                      </div>
              ...
              <div id="tab2" class="tab-cont hidden bg-pale-green pt-36 pc:pt-64 px-16 pc:px-72 pb-40 overflow-hidden">
                <div class="relative flex flex-col items-center gap-24 pc:gap-32">
                  <div class="flex justify-center items-center flex-wrap pc:flex-nowrap gap-y-12">
                    ...
                    <div class="ml-38 pc:ml-64">
                      <div class="flex items-center gap-x-12 pc:gap-x-24">
                        ...
                        <span class="text-17 pc:text-33 leading-none half-leading">¥48,400</span>
                      </div>
                    </div>
                    <div class="ml-0 md:ml-80">
                      <p class="text-10 pc:text-25">所要時間：2時間</p>
                  ...
                  <div class="flex justify-center">
                    <div class="md:w-568">
                      <img src="/wp-content/themes/studio-tanak_theme/src/images/legacy-old/seijinshiki-ladies/20W_maeB.webp" alt="" class="w-full" width="889" height="257">
                    </div>
                  </div>
                  <div class="w-full h-px bg-black"></div>
                  <div class="w-full pc:w-auto">
              ...
              <div id="tab3" class="tab-cont hidden bg-pale-yellow pt-36 pc:pt-64 px-16 pc:px-72 pb-40 overflow-hidden">
                <div class="relative flex flex-col items-center gap-24 pc:gap-32">
                  <div class="flex justify-center items-center flex-wrap pc:flex-nowrap gap-y-12">
                    <div>
                      <div class="flex items-center gap-x-12 pc:gap-x-24">
                        ...
                        <span class="text-17 pc:text-33 leading-none half-leading">¥64,900</span>
                      </div>
                    </div>
                    <div class="ml-38 pc:ml-64">
                      <div class="flex items-center gap-x-12 pc:gap-x-24">
                        ...
                        <span class="text-17 pc:text-33 leading-none half-leading">¥70,400</span>
                      </div>
                    </div>
                    <div class="ml-0 md:ml-80">
                      <p class="text-10 pc:text-25">所要時間：2時間</p>
                  ...
                  <div class="flex justify-center">
                    <div class="md:w-568">
                      <img src="/wp-content/themes/studio-tanak_theme/src/images/legacy-old/seijinshiki-ladies/20W_maeC.webp" alt="" class="w-full" width="889" height="257">
                    </div>
                  </div>
                  <div class="w-full h-px bg-black"></div>
                  <div class="w-full pc:w-auto">
            ...
            <div class="mt-32 pc:mt-64">
              <div class="mx-auto md:w-400 pc:w-full border border-border">
                <div class="bg-[#B0B0B0] h-35 pc:h-60 flex justify-center items-center">
                  <h3 class="text-12 pc:text-20 text-white">前撮り後お出かけ（17:00迄）</h3>
                </div>
                  ...
                  <ul class="flex flex-col pc:h-108 flex-wrap gap-x-80">
                    <li class="w-full pc:w-1/2 py-8 border-b border-border border-dashed flex justify-between items-center">
                      ...
                      <div class="flex items-center gap-x-40">
                        ...
                        <span class="text-12 pc:text-20 text-red">
                          ¥22,000
                        </span>
                      </div>
                    </li>
            ...
            <div class="mt-64 pc:mt-160">
              <div class="flex items-center flex-col gap-y-4 pc:gap-y-8">
                <h2 class="text-14 pc:text-30 font-zen-maru-gothic half-leading">成人式女性 当日メニュー</h2>
              </div>
            </div>
              ...
              <div class="bg-pale-gray pt-36 pc:pt-64 px-16 pc:px-72 pb-40 overflow-hidden">
                ...
                <div class="relative opacity-100 visible h-auto transition-opacity duration-300 flex flex-col items-center gap-24 pc:gap-32">
                  ...
                  <div class="flex justify-center items-center flex-wrap pc:flex-nowrap gap-y-12">
                    <div class="flex items-center gap-x-12 pc:gap-x-24">
                      <div class="flex items-center gap-x-8 pc:gap-x-12">
                        ...
                        <span class="text-17 pc:text-33 leading-none half-leading">¥26,400</span>
                      </div>
                    ...
                    <div class="ml-0 md:ml-80">
                      <p class="text-10 pc:text-25">所要時間：3～4時間</p>
                    </div>
                  </div>
                  <div class="flex justify-center">
                    <div class="md:w-568">
                      <img src="/wp-content/themes/studio-tanak_theme/src/images/legacy-old/seijinshiki-ladies/20W_maeA.webp" alt="" class="w-full" width="890" height="193">
                    </div>
                  </div>
                  <div class="w-full h-px bg-black"></div>
                  <div class="self-stretch">
                    <div class="flex flex-col pc:flex-row flex-wrap items-center justify-center gap-y-16 pc:gap-x-80">
                      <div class="max-pc:order-1 grid grid-cols-2 gap-x-56 pc:gap-x-40 flex-1">
                        <div class="flex items-center flex-col gap-8">
                          <div class="h-62 pc:h-90 flex justify-center items-center">
                            <div class="w-57 pc:w-80">
                              <img src="/wp-content/themes/studio-tanak_theme/src/images/legacy-old/common/make.svg" alt="" class="w-full" width="103" height="140">
                      ...
                      <div class="max-pc:order-3 w-full md:w-560 pc:w-880">
                        ...
                        <div class="bg-white pt-8 pc:pt-12 pb-4 pc:pb-8 px-64">
                          <div class="grid grid-cols-3 md:grid-cols-6 gap-24 pc:gap-32">
                            ...
                            <div class="flex flex-col items-center justify-center">
                              <div class="w-48 pc:w-88">
                                <img src="/wp-content/themes/studio-tanak_theme/src/images/legacy-old/common/Dgrade.svg" alt="Dグレード" class="w-full" width="91" height="91">
                              </div>
                              <span class="text-12 pc:text-23 leading-[1.8]">¥165,000</span>
                            </div>
                            <div class="flex flex-col items-center justify-center">
                              <div class="w-48 pc:w-88">
                                <img src="/wp-content/themes/studio-tanak_theme/src/images/legacy-old/common/Egrade.svg" alt="Eグレード" class="w-full" width="91" height="91">
                              </div>
                              <span class="text-12 pc:text-23 leading-[1.8]">¥220,000</span>
                            </div>
                            <div class="flex flex-col items-center justify-center">
                              <div class="w-48 pc:w-88">
                                <img src="/wp-content/themes/studio-tanak_theme/src/images/legacy-old/common/Sgrade.svg" alt="Sグレード" class="w-full" width="91" height="91">
                              </div>
                      ...
                      <div class="max-pc:order-2 w-full">
                        <p class="text-10 pc:text-16 -indent-[1em] pl-[1em] half-leading max-pc:text-center">※ヘア/メイク/着付けは本人分のみとなっております。</p>
                        <p class="text-10 pc:text-16 -indent-[1em] pl-[1em] half-leading max-pc:text-center">
                          ※混雑状況により所要時間は前後する可能性がございます。
                        </p>
                      </div>
                    </div>
                  ...
                  <div class="w-full">
                    ...
                    <div class="mt-24 pc:mt-32 w-full">
                      <div class="border border-border flex flex-col">
                        <div class="bg-[#E40063] h-35 pc:h-60 flex justify-center items-center">
                          <h3 class="text-12 pc:text-20 text-white">ご持参頂くもの</h3>
                        </div>
            ...
            <div class="mt-64 pc:mt-160">
              <div class="flex items-center flex-col gap-y-4 pc:gap-y-8">
                <h2 class="text-14 pc:text-30 font-zen-maru-gothic half-leading">成人式女性 当日お持ち込みメニュー</h2>
              </div>
            </div>
            ...
            <div class="mt-40 pc:mt-80">
              ...
              <div class="bg-pale-gray pt-36 pc:pt-64 px-16 pc:px-72 pb-40 overflow-hidden">
                ...
                <div class="relative opacity-100 visible h-auto transition-opacity duration-300 flex flex-col items-center gap-24 pc:gap-32">
                  <!-- <div id="tab4" class="tab-cont relative opacity-0 invisible h-0 transition-opacity duration-300 flex flex-col items-center gap-24 pc:gap-32"> -->
                  <div class="flex justify-center items-center flex-wrap pc:flex-nowrap gap-12">
                    <div class="flex items-center gap-x-12 pc:gap-x-24">
                      <div class="flex items-center gap-x-8 pc:gap-x-12">
                        <div class="h-16 pc:h-30 px-8 pc:px-16 bg-white border border-black flex justify-center items-center">
                          <span class="text-8 pc:text-16 leading-none half-leading">基本価格</span>
                  ...
                  <div class="self-stretch">
                    ...
                    <div class="mt-24 pc:mt-32">
                      <p class="text-10 pc:text-16 -indent-[1em] pl-[1em] half-leading">※ヘア/メイク/着付けは本人分のみとなっております。</p>
                      <p class="text-10 pc:text-16 -indent-[1em] pl-[1em] half-leading">※振袖のお持ち込みは無料</p>
            ...
            <div class="mt-32 pc:mt-64">
              <div class="mx-auto md:w-full border border-border">
                ...
                <div class="bg-white pt-16 pc:pt-24 pb-20 pc:pb-40 px-24 md:px-40 pc:px-160">
                  <ul class="flex max-md:flex-col flex-wrap h-70 md:h-54 gap-x-24 md:gap-x-40">
                    <li class="w-[calc((100%_-_(24rem_*_1))_/_2)] md:w-[calc((100%_-_(40rem_*_3))_/_4)] py-8 border-b border-border border-dashed flex justify-between items-center">
