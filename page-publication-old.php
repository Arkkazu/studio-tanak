  ...
  <div class="max-pc:pb-48">
    ...
    <main class="py-70 pc:py-160 ">
      ...
      <div class="relative w-full">
        <picture>
          <source media='(min-width: 768px)' srcset='/wp-content/themes/studio-tanak_theme/src/images/legacy-old/publication/gooutimg_pc2.webp'>
          <img class='w-full' src='/wp-content/themes/studio-tanak_theme/src/images/legacy-old/publication/gooutimg_sp2.webp' alt='出張撮影' loading='lazy' width='1125' height='1130'>
        </picture>
