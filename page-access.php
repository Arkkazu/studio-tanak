...
<main class="overflow-hidden bg-white pb-160 pc:pb-240">
  <section class="relative aspect-square pc:aspect-[1920/480] overflow-hidden bg-[#f1ede7]" aria-labelledby="access-page-title">
    <div class="relative h-full">
      <div class="absolute inset-0 mx-auto max-w-920">
        <h1 id="access-page-title" class="absolute left-24 pc:left-64 top-96 pc:top-176 z-10 text-18 pc:text-20 text-white font-montserrat font-light leading-none tracking-[0.18em] pc:tracking-[0.22em] [writing-mode:vertical-rl] pc:[writing-mode:horizontal-tb]">
          ACCESS
        </h1>
      </div>
      <picture>
  ...
  <section class="px-20 pt-80 pc:pt-150" aria-labelledby="access-information-title">
    <div class="mx-auto flex max-w-440 flex-col items-center">
      ...
      <address class="text-center text-10 pc:text-12 font-noto-sans not-italic leading-[1.8]">
        <p>〒370-0828 群馬県高崎市宮元町270 3F</p>
        <p>TEL 027-325-4649</p>
        <p>受付時間：10:00〜18:00&nbsp;&nbsp;定休日：火曜／第1・3水曜</p>
      </address>

      <img class="mt-24 block w-294" src="<?php echo esc_url($access_map_src); ?>" alt="高崎市役所とJR高崎駅周辺の地図" loading="lazy" <?php echo $access_map_wh; ?>>

      <a class="mt-24 flex min-h-42 w-294 items-center justify-center border border-black text-11 pc:text-12 font-noto-sans leading-none transition-opacity duration-300 hoverable:hover:opacity-50" href="https://www.google.com/maps/search/?api=1&amp;query=群馬県高崎市宮元町270" target="_blank" rel="noopener noreferrer">
        google mapで見る
      </a>

      <section class="mt-160 flex w-full flex-col items-center" aria-labelledby="access-parking-title">
        <h2 id="access-parking-title" class="flex min-h-42 w-160 items-center justify-center border border-black text-14 pc:text-16 font-montserrat leading-none tracking-[0.05em]">
          PARKING
        </h2>
        ...
        <img class="mt-24 block w-320" src="<?php echo esc_url($access_parking_src); ?>" alt="スタジオ周辺の駐車場案内図" loading="lazy" <?php echo $access_parking_wh; ?>>
      </section>
    </div>
  </section>
</main>
