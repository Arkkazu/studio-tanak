    ...
    indicator.addEventListener("click", () => {
      ...
      if (scrollTarget) {
        ...
        indicators.forEach((item) => {
          item.classList.toggle("w-40", item === indicator);
          item.classList.toggle("opacity-100", item === indicator);
          item.classList.toggle("w-24", item !== indicator);
          item.classList.toggle("opacity-60", item !== indicator);
        });
